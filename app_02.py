...
# ════════════════════════════════════════════════════════════
#  TAB 2 — FORECAST ENGINE (RESTORED IMPLICIT BRIDGES)
# ════════════════════════════════════════════════════════════
with tab2:
    if model is None:
        ...
        # RESTORED: Continuous Bridge mapping loops to eliminate future gaps seamlessly
        ...
        # Core Target Window Forecast Trace
...
# ════════════════════════════════════════════════════════════
#  TAB 3 — ADVANCED VISUALIZATIONS (RESTORED ALL MISSING PLOTS)
# ════════════════════════════════════════════════════════════
with tab3:
    # Compile the comprehensive combined dataset matrix
    df_vis = df.copy()
    
    # Inject bridge rows into visualization matrix if present
    if b_dates is not None and len(b_dates) > 0:
    ...
    # Inject forecast rows into visualization matrix
    if f_prices is not None:
    ...
    # Recalculate indicators across unified timeline to ensure graphs render fully
    ...
    # Row 1: Unified Continuous Pricing Lines + Volumes
